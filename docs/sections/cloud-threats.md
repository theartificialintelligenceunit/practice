...
<ul>
  <li>Exploit vulnerabilities, e.g., <a href="https://www.technologyreview.com/2021/09/23/1036140/2021-record-zero-day-hacks-reasons/" target="_blank">zero-day</a> vulnerabilities.</li>
  <li>Data theft via unauthorised access to computing assets.</li>
  <li>Intentional disabling or destruction of computing assets, or disruption of services.</li>
</ul>
...
<ul>
  <li>Insiders, i.e., employees or contractors.</li>
